...
public class TennesseeEnemy extends Enemy{
	public TennesseeEnemy(ArrayList<PathTile> tilearrayPath, PathTile start, ArrayList<PathTile> endPoints) {
	...
	public void draw(Graphics g) {
		if(visible) {
			g.drawImage(Assets.tennesseeVols, x, y);		
		}
	}
